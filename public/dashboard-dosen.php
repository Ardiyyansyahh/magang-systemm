...
<table class="w-full table-auto border mb-6">
    ...
    $surat = trim($files[1]);
    ?>
    <a href="../uploads/<?= $proposal ?>" target="_blank" class="text-blue-600 hover:underline">Lihat Proposal</a><br>
    <a href="../uploads/<?= $surat ?>" target="_blank" class="text-blue-600 hover:underline">Lihat Surat</a>
            </td>
            ...
            <td class="px-4 py-2">
                <form method="POST" action="../dosen/update-status-pendaftaran.php">
                    ...
                    <input type="text" name="komentar" placeholder="Komentar..." class="border px-2 py-1 mb-1 rounded w-full">
